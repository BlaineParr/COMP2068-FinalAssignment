    ...
    export class Play3 {
        ...
        constructor() {
            ...
            for (var biklops = 2; biklops >= 0; biklops--) {
                this.biklopses[biklops] = new objects.Biklops(Math.floor(Math.random() * 702) + 64, Math.floor(Math.random() * 384) + 64, this.game, this.robin, this.biklopses, this.scoreboard);
